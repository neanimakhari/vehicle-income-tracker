...
/** Simple QR via public QR API for install URL printables. */
export function VitAppQrCard() {
  const url = "https://vit-app.vehinc.co.za";
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <p className="mt-1 text-sm text-zinc-500">
        Print this for vehicles or driver cards. Drivers still sign in before downloading.
      </p>
