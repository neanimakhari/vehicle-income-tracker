...
export default function ResetPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Platform auth: reset for tenant admin (or platform admin) account
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  minLength={8}
                  className="block w-full pl-10 pr-12 py-3 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
